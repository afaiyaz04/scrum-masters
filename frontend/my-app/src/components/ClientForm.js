    ...
    <Form {...layout}>
      ...
      {props.showDetails && (
        <Form.Item wrapperCol={{ ...layout.wrapperCol, offset: 8 }}>
          <Button className='general-btn' onClick={() => props.updateAction(contact)}>Update</Button>
          <Button className='general-btn' onClick={() => props.deleteAction(contact.id)}>Delete</Button>
        </Form.Item>
      )}
      {props.addContact && (
        <Form.Item wrapperCol={{ ...layout.wrapperCol, offset: 8 }}>
          <Button className='general-btn' onClick={() => props.createAction(contact)}>Create</Button>
        </Form.Item>
      )}
    </Form>
  );
