        ...
        <div className="dashboard">
          ...
          <div className="progress">
            <Progress
              ...
              format={() => `${this.state.ordersCreated.length} Orders Created`}
              strokeColor="#ff4d4f"
            />
            <Progress
              percent={
            ...
            <Progress
              ...
              format={() => `${this.state.ordersAgreed.length} Orders Agreed`}
              strokeColor="#1890ff"
            />
            <Progress
              percent={
              ...
              format={() => `${this.state.ordersSigned.length} Orders Signed`}
              strokeColor="#52c418"
            />
          </div>
